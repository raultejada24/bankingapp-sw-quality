...
#### Refactorización realizada - Hecho por: [Gonzalo Andrés Zurdo]
...
_En esta captura se aprecia que, inicialmente, la clase carecía por completo de pruebas unitarias (0% de ramas cubiertas)._
...
_Tras la implementación del plan de pruebas, se ha logrado alcanzar el 98% de cobertura de ramas (Branches) e instrucciones accesibles, estableciendo la red de seguridad necesaria para la refactorización._
...
_(Documento preparado por Grupo 7 - Análisis de Calidad)_
