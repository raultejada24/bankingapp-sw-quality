 ...
 * Responsabilidades: Verificar el flujo web de transferencias, validaciones, errores y balances
 * 
 * Criterios de éxito:
 * - Todas las pruebas son independientes (no dependen de datos de otras pruebas)
 ...
 * 
 * Casos de Prueba:
 * 1. transferOwnAccounts_Success: Transferencia entre cuentas propias del mismo usuario
 * 2. transferDifferentUsers_Success: Transferencia entre cuentas de distintos usuarios
 * 3. transferSameAccount_Fail: No se puede transferir a la misma cuenta
 * 4. transferInsufficientBalance_Fail: No se puede transferir sin saldo suficiente
...
public class TransferE2ETest {
    ...
    void transferOwnAccounts_SuccessTest() {
        ...
        assertEquals(expectedBalance1, finalBalance1, 0.01, 
            "Saldo cuenta origen debe disminuir en €1000. Esperado: " + expectedBalance1 + ", Obtenido: " + finalBalance1);
        assertEquals(expectedBalance2, finalBalance2, 0.01,
            "Saldo cuenta destino debe aumentar en €1000. Esperado: " + expectedBalance2 + ", Obtenido: " + finalBalance2);
    ...
    void transferDifferentUsers_SuccessTest() {
        ...
        assertEquals(expectedBalanceCustomer, finalBalanceCustomer, 0.01,
            "Saldo cuenta origen (customer) debe disminuir en €500. Esperado: " + expectedBalanceCustomer + ", Obtenido: " + finalBalanceCustomer);
     ...
     * Then: Aparece mensaje de error indicando que no puede transferir a la misma cuenta
     */
    @Test
